 ...
 */
final class Version20210202210604 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, first_name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, surname VARCHAR(255) DEFAULT NULL, firstname_parent1 VARCHAR(255) DEFAULT NULL, surname_parent1 VARCHAR(255) DEFAULT NULL, firstname_parent2 VARCHAR(255) DEFAULT NULL, surname_parent2 VARCHAR(255) DEFAULT NULL, firstname_educateur VARCHAR(255) DEFAULT NULL, surname_educateur VARCHAR(255) DEFAULT NULL, firstname_orthophoniste VARCHAR(255) DEFAULT NULL, surname_orthophoniste VARCHAR(255) DEFAULT NULL, enabled TINYINT(1) NOT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, confirmation_reset_password VARCHAR(255) DEFAULT NULL, date_de_naissance DATE DEFAULT NULL, created_at DATETIME DEFAULT NULL, last_login DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
